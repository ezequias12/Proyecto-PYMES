...
async function Modificar(categoria) {
  // simula
  let categoriaEncontrado = arrayCategoria.find(
    (categoriafind) => categoriafind.IdCategoria === categoria.IdCategoria
  );
...
async function Eliminar(IdCategoria) {
  let categoriaEncontrado = arrayCategoria.find(
    (categoriafind) => categoriafind.IdCategoria === IdCategoria
  );
  if (categoriaEncontrado) {
